...
from tools import hashtag_tool, news_tool, search_gmail_combined_tool, datetime_tool

load_dotenv()

# Define the tools that the agent can use
tools = [datetime_tool, search_gmail_combined_tool, news_tool, hashtag_tool]
